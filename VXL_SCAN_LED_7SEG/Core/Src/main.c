...
/* USER CODE BEGIN PV */
const uint8_t LED[] = {0xC0,0xF9,0xA4,0xB0,0x99,0x92,0x82,0xF8,0x80,0x90,0xFF};
GPIO_TypeDef* GPIO_PORTS[] = {PB0_GPIO_Port, PB1_GPIO_Port, PB2_GPIO_Port, PB3_GPIO_Port, PB4_GPIO_Port, PB5_GPIO_Port, PB6_GPIO_Port, PB7_GPIO_Port};
uint16_t GPIO_PINS[] = {PB0_Pin, PB1_Pin, PB2_Pin, PB3_Pin, PB4_Pin, PB5_Pin, PB6_Pin, PB7_Pin};
/* USER CODE END PV */
